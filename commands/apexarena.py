import nextcord
import misc
from sendreq import apexapiget
from commands.base_command import BaseCommand


class apexarena(BaseCommand):
    def __init__(self):
    ...
    async def handle(self, params, message, client):
        ...
        try:
            res = apexapiget(
                f'https://api.mozambiquehe.re/bridge?version=5&platform={platup}&player={name}')
            if "Error" in res:
                ...
                msg.set_author(name="Apex Legends Ranked Arena",
                               icon_url="https://cdn.statically.io/img/raw.githubusercontent.com/w=20,h=20/gxjakkap/rankbot-img/main/img/gameicon/apex.png")
